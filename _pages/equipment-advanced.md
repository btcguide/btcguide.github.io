...
Read more about backing up your public keys [here](#backup-public-keys).
...
Verifying receive addresses on a quorum of trusted devices [is incredibly important](#verify-receive-address).
